sap.ui.define([
	...
	return BaseObject.extend("demo.model.GroupSortState", {
		 ...
		 * @alias demo.model.GroupSortState
		 */
		...
		/**
		 * Groups by Height, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "Height") {
				...
				this._oViewModel.setProperty("/sortBy", "Height");

				aSorters.push(
					new Sorter("Height", false,
