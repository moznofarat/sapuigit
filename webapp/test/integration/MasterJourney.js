sap.ui.define([
		...
		opaTest("MasterList Filtering on Height less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("<Height>").
		...
		opaTest("MasterList Filtering on Height more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 <>").
				and.iPressOKInViewSelectionDialog();
